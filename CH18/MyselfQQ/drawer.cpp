	...
	:QToolBox(parent, f)
{
	...
	/*auto create_boolbtn = [this](QString text, QPixmap icon) {
		auto btn = new MyToolBtn;
		btn->setText(text);
		btn->setIcon(icon);
		...
		btn->setup();
		connect(btn, SIGNAL(clicked_ex(MyToolBtn*)), this, SLOT(slot_show_chat_widget(MyToolBtn*)));
		return btn;
	};

	toolBtn1 = create_boolbtn(tr("水漂奇鼋"), QPixmap(":/images/spqy.png"));
	toolBtn2 = create_boolbtn(tr("忆梦如澜"), QPixmap(":/images/ymrl.png"));
	toolBtn3 = create_boolbtn(tr("北京出版人"), QPixmap(":/images/qq.png"));
	toolBtn4 = create_boolbtn(tr("Cherry"), QPixmap(":/images/Cherry.png"));
	toolBtn5 = create_boolbtn(tr("淡然"), QPixmap(":/images/dr.png"));
	toolBtn6 = create_boolbtn(tr("娇娇girl"), QPixmap(":/images/jj.png"));
	toolBtn7 = create_boolbtn(tr("落水无痕"), QPixmap(":/images/lswh.png"));
	toolBtn8 = create_boolbtn(tr("青墨暖暖"), QPixmap(":/images/qmnn.png"));
	toolBtn9 = create_boolbtn(tr("无语"), QPixmap(":/images/wy.png"));*/
...
void Drawer::slot_show_chat_widget(MyToolBtn* btn)
{
	auto w = new Widget(0, btn->text());
